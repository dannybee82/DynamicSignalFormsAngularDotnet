...
@Component({
  selector: 'app-create-input-boolean',
  imports: [AllMaterialsModule, FormField, ValidationsComponent],
  templateUrl: './create-input-boolean.component.html',
  styleUrl: './create-input-boolean.component.scss',
})
export class CreateInputBooleanComponent  implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.inputForm.propertyType().setControlValue(PropertyType.BOOLEAN);  
  }

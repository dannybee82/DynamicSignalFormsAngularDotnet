...
@Component({
  selector: 'app-create-input-float',
  imports: [AllMaterialsModule, FormField, ValidationsComponent],
  templateUrl: './create-input-float.component.html',
  styleUrl: './create-input-float.component.scss',
})
export class CreateInputFloatComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.inputForm.propertyType().setControlValue(PropertyType.NUMBER);
  }

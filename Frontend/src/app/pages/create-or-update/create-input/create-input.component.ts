...
export class CreateInputComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    switch(this.formType()) {
      case ShowFormType.INPUT_TEXT:
        this.inputForm.propertyType().setControlValue(PropertyType.STRING);
        break;
      case ShowFormType.INPUT_DATE:
        this.inputForm.propertyType().setControlValue(PropertyType.DATE);
        break;
    }    
  }
